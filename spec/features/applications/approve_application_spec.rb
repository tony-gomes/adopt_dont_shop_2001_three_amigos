...
RSpec.describe 'As a visitor' do
  ...
  context 'When I visit an application#show page I see a link to approve the application for that each pet' do
    context 'If I click on a link to approve a pet application I am taken that pet#show page' do
      it 'I see the pet status changed to pending & I see text identifying who the pet is on hold for' do
